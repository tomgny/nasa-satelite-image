<template>
  ...
  <div class="container center-block text-center">
    ...
    <app-loading v-if="this.isLoading"></app-loading>
    <div v-show="this.showMaps && !this.isLoading">
      <div class="row">
        <div class="col-xs-12 col-sm-offset-2 col-md-offset-3">
          <img id="nasa" :src="imageUrl" alt="" class="img-thumbnail" />
        </div>
      </div>
      <div class="row">
        <!-- <div class="col-xs-12 col-sm-offset-2 col-md-offset-3"> -->
    ...
    async fetchLocation(city) {
      try {
        ...
        this.locationList = data.filter(
          (value, index, array) =>
            array.findIndex(t => t.display_name === value.display_name) ===
            index
        );
        console.log(data);
        this.isLoading = false;
